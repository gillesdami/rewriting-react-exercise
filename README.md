...
You can preview the app we will build with our custom react [here](https://no2ehi.github.io/simple-todo-app-react/).
...
The childrens need to be added to our element, they can either be a string or an HTML element. Indeed, it will never be a React component because the React component would have already been processed by createElement which returns an HTML element.
